...
const products = [
  {
    ...
    features: ["Comprehensive guide to micro-organism health benefits", "Written by health expert O'Neill", "English language edition", "Evidence-based natural healing approaches", "Practical wellness strategies"],
    inStock: true,
  },
  {
    id: "2",
    ...
    features: ["Bluetooth 5.0 for stable connection", "24-hour battery life with charging case", "IPX7 waterproof rating", "Touch control for music and calls", "Premium sound with deep bass"],
    inStock: true,
  },
  {
    id: "3",
    ...
    features: ["Wireless charging pad for smartphones", "Adjustable brightness and color temperature", "USB charging port for devices", "Eye-care LED technology", "Modern minimalist design"],
    inStock: true,
  },
  {
    id: "4",
    ...
    features: ["RFID blocking technology", "Genuine leather construction", "Holds 12 cards plus cash", "Slim minimalist design", "Multiple color options"],
    inStock: true,
  },
  {
    id: "5",
    ...
    features: ["100% natural jade stone", "Reduces facial puffiness and tension", "Promotes lymphatic drainage", "Enhances skincare product absorption", "Includes storage case"],
    inStock: true,
  },
];
